...
<div class="row" style="display: none" id="model"> 
	<div class="col-12"> 
		<form action="../controller/avisos_professor.php?id=1" method="post"> 
			<div class="row">
				<div class="col-md-12">
...
<script type="text/javascript">
	...
	function remover(codigo){
		...
		if (confirm) {
			window.location.href = '../controller/avisos_professor.php?id=2&&codigo=' + codigo
		}
	}
	function destinatario(codigo){
		$.post(
			"../controller/avisos_professor.php?id=3",
			{codigo: codigo},
			function(result){
				var txt = "";
				for(index in result){
